  ...
  return (
    <footer className="bg-zinc-700 mt-6 h-50">
      <section className="grid grid-cols-1 place-items-center">
        <nav className="flex items-center justify-center gap-4 sm:mt-8 xs:mt-6 mt-4">
          <a
            href="https://www.instagram.com/simplytogether.e/"
            target="_blank"
            rel="noopener noreferrer"
            className="sm:text-lg xs:text-md text-sm bg-white/50 p-2 rounded-full flex items-center text-zinc-700"
          >
        ...
        <p className="sm:mb-8 mx-4 xs:mb-6 mb-4 text-white/50 text-[10px] xs:text-xs sm:text-sm text-center">
