...
const Homepage = () => {
  return (
    <div>
      <div className=" overflow-hidden h-[65vh] mt-12">
        <div className="relative flex items-center max-w-full h-4/6">
          <img
            className="relative top-10 left-0 w-80 object-cover"
            src={photo0}
            alt="ste1"
          />
          <img
            className="relative w-60 top-4 right-10 z-20 object-cover"
            src={photo1}
            alt="ste2"
          />
          <img
            className="relative w-56 top-24 right-16 z-10 object-cover"
            src={photo2}
            alt="ste3"
          />
          <img
